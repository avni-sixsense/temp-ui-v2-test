...
import WaferAutoClassificationTableChart from '../../Charts/WaferAutoClassificationTableChart';
...
const WaferAutoClassificationTable = ({ defaultDateRange }) => {
  ...
  //     console.log(x);
  //   }
  //   searchParams.set('autoClassification', mode);
  //   for (const x of searchParams.entries()) {
  //     console.log(x);
  //   }
  ...
  return (
    <Box mb={2} className={`${classes.root}`}>
      ...
      <Box pl={1.5} pr={1.25}>
        <WaferAutoClassificationTableChart
          tableFilter={mode}
...
export default WaferAutoClassificationTable;
