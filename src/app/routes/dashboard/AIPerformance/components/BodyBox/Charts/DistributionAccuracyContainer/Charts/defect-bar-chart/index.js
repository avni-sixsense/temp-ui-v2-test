  ...
  const options = {
    ...
    tooltip: {
      custom({ dataPointIndex }) {
        if (dataPointIndex === 0) {
          return `<div class="tooltip_container"><div class='cohort_tooltip'> <div class='greenBox'></div> <div>Recall >= 90%</div></div></div>`.replaceAll(
            ',',
            ''
          );
        }
        if (dataPointIndex === 1) {
          return `<div class="tooltip_container"><div class='cohort_tooltip'> <div class='yellowBox'></div> <div>Recall 80% - 90%</div></div></div>`.replaceAll(
            ',',
            ''
          );
        }
        if (dataPointIndex === 2) {
          return `<div class="tooltip_container"><div class='cohort_tooltip'> <div class='redBox'></div> <div>Recall < 80%</div></div></div>`.replaceAll(
            ',',
            ''
          );
        }
